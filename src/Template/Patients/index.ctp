    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('carrir_id') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $patient->has('carrir') ? $this->Html->link($patient->carrir->name, ['controller' => 'Carrirs', 'action' => 'view', $patient->carrir->id]) : '' ?></td>

 ...
 * @var \App\Model\Entity\Carrir $carrir
 */
?>
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <?= $this->Element('actions', array('value' => 'Carrier', 'values' => 'Carriers')); ?>
</nav>
<div class="carrirs view large-9 medium-8 columns content">
    <h3><?= h($carrir->name) ?></h3>
    <table class="vertical-table">
        ...
        <tr>
            <th scope="row"><?= __('Carrir Code') ?></th>
    ...
    <div class="related">
        ...
        <?php if (!empty($carrir->patients)): ?>
        <table cellpadding="0" cellspacing="0">
            <tr>
                <th scope="col"><?= __('Id') ?></th>
                <th scope="col"><?= __('Carrir Id') ?></th>
            ...
            <?php foreach ($carrir->patients as $patients): ?>
            <tr>
                <td><?= h($patients->id) ?></td>
                <td><?= h($patients->carrir_id) ?></td>
